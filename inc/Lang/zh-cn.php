...
return array(
    ...
    // 
    '_ADDRESS_MANAGE_'      =>  '地址管理',
    '_ADDRESS_ADD_'         =>  '增加地址',
    '_ADDRESS_DELETE_'      =>  '删除',
    '_ADDRESS_DEFAULT_'     =>  '默认地址',
    '_ADDRESS_SAVE_'        =>  '保存地址',
    ...
    '_INPUT_CONSIGNEE_'     =>  '请输入收货人姓名',
    '_INPUT_PHONE_'         =>  '请输入手机号',
    '_INPUT_PHONE_'         =>  '请输入地址',

    '_ORDER_SUBMIT_'        =>  '订单提交成功',
    '_ORDER_CONFIRM_'       =>  '订单确认',
    '_ORDER_NUMBER_'        =>  '订单编号',
    '_ORDER_ADD_TIME_'      =>  '下单时间',
    '_ORDER_FINISH_TIME_'   =>  '送达时间',
    '_ORDER_REMARKS_'       =>  '订单备注',
    '_ORDER_STATUS_'        =>  '订单状态',
    '_ORDER_FINISHED_'      =>  '已完成',
    '_ORDER_DISTRIBUTION_'  =>  '配送中',
